...
{
    public partial class FormNeueStornoRechnung : Form
    {
        public DateTime bestellDatum { get; set; }
        public DateTime rechnungsDatum { get; set; }
        public DateTime rechnungsDatumUrsprung { get; set; }
        public string rechnungsNrUrsprung { get; set; }
        ...
        private void FormNeueRechnung_Load(object sender, EventArgs e)
        {
            ...
            txtRechnungUrsprungYear.Text = DateTime.Now.Year.ToString().Substring(2, 2);
        ...
        private void btnAuswahlBearbeiten_Click(object sender, EventArgs e)
        {
            ...
            if (listViewArtikel.SelectedItems[0].SubItems[3].Text.StartsWith("-"))
            {
                frmNA.preis = double.Parse(listViewArtikel.SelectedItems[0].SubItems[3].Text.Substring(1, listViewArtikel.SelectedItems[0].SubItems[3].Text.Length-2));
            }
            else
            {
        ...
        private void BtnSpeichern_Click(object sender, EventArgs e)
        {
            ...
            o.FileName = "R" + txtRechnungsnummer.Text + "_" + txtYear.Text + "_STORNO-R" + txtRechnungsNrUrsprung.Text + "_" + dateTimeRechnungUrsprung.Value.Date.ToString("dd_MM_yyyy");
        ...
        private void datenAusgeben()
        {
            ...
            rechnungsDatumUrsprung = dateTimeRechnungUrsprung.Value;
            rechnungsNr = txtRechnungsnummer.Text + "_" + txtYear.Text;
            rechnungsNrShort = Convert.ToInt32(txtRechnungsnummer.Text);
            rechnungsNrUrsprung= txtRechnungsNrUrsprung.Text + "_" + txtRechnungUrsprungYear.Text;
        ...
        private void cbRechnungUrsprungYear_CheckedChanged(object sender, EventArgs e)
        {
            if (cbRechnungUrsprungYear.Checked)
                txtRechnungUrsprungYear.Enabled = true;
            else
            {
                txtRechnungUrsprungYear.Enabled = false;
            }
        }
    }
}
